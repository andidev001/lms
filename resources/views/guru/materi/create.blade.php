    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm rounded-4">
            ...
            <div class="card-body p-4">
                ...
                <form method="POST" action="{{ route('guru.mapels.materis.store', $mapel->id) }}" enctype="multipart/form-data">
                    @csrf
                    
                    <div class="mb-4">
                        <label class="form-label fw-semibold text-muted">Judul Materi / Modul <span class="text-danger">*</span></label>
                        <input type="text" name="judul" class="form-control form-control-lg rounded-3" placeholder="Contoh: Modul 1: Sistem Persamaan Linear" value="{{ old('judul') }}" required>
                    </div>

                    <div class="mb-4">
                        <label class="form-label fw-semibold text-muted">Deskripsi Singkat</label>
                        <textarea name="deskripsi" class="form-control rounded-3 rich-text" rows="4" placeholder="Berikan pengantar singkat mengenai apa yang akan dipelajari pada modul ini...">{{ old('deskripsi') }}</textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="form-text mt-2"><i class="bi bi-info-circle me-1"></i> Opsional. Maksimal ukuran file: 10MB. Hanya menerima format .pdf</div>
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="input-group">
                            ...
                            <input type="url" name="url_youtube" class="form-control form-control-lg rounded-end-3" placeholder="https://www.youtube.com/watch?v=..." value="{{ old('url_youtube') }}">
                        </div>
                        <div class="form-text mt-2"><i class="bi bi-info-circle me-1"></i> Opsional. Masukkan URL lengkap Youtube.</div>
                    </div>
