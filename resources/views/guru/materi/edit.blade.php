        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm rounded-4">
                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="{{ route('guru.mapels.materis.update', [$mapel->id, $materi->id]) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="deskripsi" class="form-control rounded-3 rich-text" rows="4"
                                placeholder="Berikan pengantar singkat mengenai apa yang akan dipelajari pada modul ini...">{{ old('deskripsi', $materi->deskripsi) }}</textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            @if($materi->file_pdf)
                                <div
                                    class="mb-2 px-3 py-2 bg-light rounded-3 d-flex align-items-center justify-content-between border">
                                    <div><i class="bi bi-file-earmark-pdf text-danger me-2"></i> File saat ini: <a
                                            href="{{ asset('storage/' . $materi->file_pdf) }}" target="_blank"
                                            class="fw-bold text-decoration-none">Lihat PDF</a></div>
                                </div>
                            @endif
                            ...
                            <div class="form-text mt-2"><i class="bi bi-info-circle me-1"></i> Kosongkan jika tidak ingin
                                mengubah file PDF saat ini. Maks 10MB.</div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="url" name="url_youtube" class="form-control form-control-lg rounded-end-3"
                                    value="{{ old('url_youtube', $materi->url_youtube) }}">
                            </div>
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <input type="datetime-local" name="tenggat_waktu" class="form-control form-control-lg rounded-3"
                                value="{{ old('tenggat_waktu', $materi->tenggat_waktu ? $materi->tenggat_waktu->format('Y-m-d\TH:i') : '') }}">
